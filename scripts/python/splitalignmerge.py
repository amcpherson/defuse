...
usage = "usage: \%prog [-w] [-n] reads_end_1_fastq reads_end_2_fastq [reference_fasta output_bam]"
...
def align(fastq_end_1, fastq_end_2, bam_prefix, bam_filenames):
	...
	if options.align_type == "paired":
		...
		bam_filename_1 = bam_prefix + ".1.bam"
		bam_filename_2 = bam_prefix + ".2.bam"
		cmdrun.padd(align_command, {'fastq': fastq_end_1}, {'bam': bam_filename_1})
		cmdrun.padd(align_command, {'fastq': fastq_end_2}, {'bam': bam_filename_2})
